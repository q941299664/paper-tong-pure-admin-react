...
export default function MenuForm() {
  ...
  return (
    <FormContainer title={title}>
      ...
      >
        <Form.Item label={t('page.systemMenu.parentMenu')}>
        ...
        <Form.Item
          label={t('page.systemMenu.description')}
          name="description"
        >
          <Input.TextArea />
        </Form.Item>
        ...
        {formValues?.type && (formValues.type === MENU_TYPE.MENU || formValues.type === MENU_TYPE.FEATURE) && (
          <Form.Item
            label={t('page.systemMenu.code')}
            name="code"
          >
            <Input />
          </Form.Item>
        ...
        {formValues?.type && (formValues.type === MENU_TYPE.DIRECTORY || formValues.type === MENU_TYPE.MENU) && (
          <Form.Item
            label={t('page.systemMenu.i18nKey')}
            name="i18nKey"
          >
            <Input />
          </Form.Item>
